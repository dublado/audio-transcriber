"""
Ponto de entrada principal do sistema de transcrição.
Demonstra a composição e uso de todos os componentes.
"""
import logging
...
from src.transcription.infrastructure.transcribers.gemini_adapter import GeminiAdapter
